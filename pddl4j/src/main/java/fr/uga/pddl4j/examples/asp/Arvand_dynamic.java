...
public class Arvand_dynamic extends AbstractPlanner<ADLProblem> {
    ...
    public Plan arvand(final ADLProblem adlProblem) {
        ...
        while (!pureRandomWalk_dynamic.satisfy((Condition)adlProblem.getGoal())) {
            ...
            pureRandomWalk_dynamic = this.pureRandomWalk_dynamic(pureRandomWalk_dynamic, adlProblem);
...
/**
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            final Arvand_dynamic planner = new Arvand_dynamic();
